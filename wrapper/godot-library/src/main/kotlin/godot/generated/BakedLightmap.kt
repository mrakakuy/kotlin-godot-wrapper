...
open class BakedLightmap : VisualInstance {
    ...
    open fun bake(fromNode: Object? = null, createVisualDebug: Boolean = false): BakedLightmap.BakeError {
        return BakedLightmap.BakeError.fromInt(_icall_Long_nObject_Boolean(bakeMethodBind, this.rawMemory, fromNode, createVisualDebug))
    }
