...
open class CanvasItem : Node {
    ...
    open fun drawTexture(texture: Texture, position: Vector2, modulate: Color = Color(1,1,1,1), normalMap: Texture? = null) {
        _icall_Unit_Object_Vector2_Color_nObject(drawTextureMethodBind, this.rawMemory, texture, position, modulate, normalMap)
    }


    private val drawTextureRectMethodBind: CPointer<godot_method_bind> by lazy { getMB("CanvasItem", "draw_texture_rect") }
    open fun drawTextureRect(texture: Texture, rect: Rect2, tile: Boolean, modulate: Color = Color(1,1,1,1), transpose: Boolean = false, normalMap: Texture? = null) {
        _icall_Unit_Object_Rect2_Boolean_Color_Boolean_nObject(drawTextureRectMethodBind, this.rawMemory, texture, rect, tile, modulate, transpose, normalMap)
    }


    private val drawTextureRectRegionMethodBind: CPointer<godot_method_bind> by lazy { getMB("CanvasItem", "draw_texture_rect_region") }
    open fun drawTextureRectRegion(texture: Texture, rect: Rect2, srcRect: Rect2, modulate: Color = Color(1,1,1,1), transpose: Boolean = false, normalMap: Texture? = null, clipUv: Boolean = true) {
        _icall_Unit_Object_Rect2_Rect2_Color_Boolean_nObject_Boolean(drawTextureRectRegionMethodBind, this.rawMemory, texture, rect, srcRect, modulate, transpose, normalMap, clipUv)
    }
    ...
    open fun drawPrimitive(points: PoolVector2Array, colors: PoolColorArray, uvs: PoolVector2Array, texture: Texture? = null, width: Double = 1.0, normalMap: Texture? = null) {
        _icall_Unit_PoolVector2Array_PoolColorArray_PoolVector2Array_nObject_Double_nObject(drawPrimitiveMethodBind, this.rawMemory, points, colors, uvs, texture, width, normalMap)
    }


    private val drawPolygonMethodBind: CPointer<godot_method_bind> by lazy { getMB("CanvasItem", "draw_polygon") }
    open fun drawPolygon(points: PoolVector2Array, colors: PoolColorArray, uvs: PoolVector2Array = PoolVector2Array(), texture: Texture? = null, normalMap: Texture? = null, antialiased: Boolean = false) {
        _icall_Unit_PoolVector2Array_PoolColorArray_PoolVector2Array_nObject_nObject_Boolean(drawPolygonMethodBind, this.rawMemory, points, colors, uvs, texture, normalMap, antialiased)
    }


    private val drawColoredPolygonMethodBind: CPointer<godot_method_bind> by lazy { getMB("CanvasItem", "draw_colored_polygon") }
    open fun drawColoredPolygon(points: PoolVector2Array, color: Color, uvs: PoolVector2Array = PoolVector2Array(), texture: Texture? = null, normalMap: Texture? = null, antialiased: Boolean = false) {
        _icall_Unit_PoolVector2Array_Color_PoolVector2Array_nObject_nObject_Boolean(drawColoredPolygonMethodBind, this.rawMemory, points, color, uvs, texture, normalMap, antialiased)
    }
    ...
    open fun drawMesh(mesh: Mesh, texture: Texture, normalMap: Texture? = null) {
        _icall_Unit_Object_Object_nObject(drawMeshMethodBind, this.rawMemory, mesh, texture, normalMap)
    }


    private val drawMultimeshMethodBind: CPointer<godot_method_bind> by lazy { getMB("CanvasItem", "draw_multimesh") }
    open fun drawMultimesh(mesh: Mesh, texture: Texture, normalMap: Texture? = null) {
        _icall_Unit_Object_Object_nObject(drawMultimeshMethodBind, this.rawMemory, mesh, texture, normalMap)
    }
