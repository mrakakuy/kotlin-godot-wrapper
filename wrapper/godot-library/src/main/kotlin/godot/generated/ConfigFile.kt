...
open class ConfigFile : Reference {
    ...
    open fun getValue(section: String, key: String, default: Variant? = null): Variant {
        return _icall_Variant_String_String_nVariant(getValueMethodBind, this.rawMemory, section, key, default)
    }
