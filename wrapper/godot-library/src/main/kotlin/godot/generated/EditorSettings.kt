...
open class EditorSettings : Resource {
    ...
    open fun getProjectMetadata(section: String, key: String, default: Variant? = null): Variant {
        return _icall_Variant_String_String_nVariant(getProjectMetadataMethodBind, this.rawMemory, section, key, default)
    }
