...
open class GIProbe : VisualInstance {
    ...
    open fun bake(fromNode: Object? = null, createVisualDebug: Boolean = false) {
        _icall_Unit_nObject_Boolean(bakeMethodBind, this.rawMemory, fromNode, createVisualDebug)
    }
