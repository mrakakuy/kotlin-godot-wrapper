...
open class GraphNode : Container {
    ...
    open fun setSlot(idx: Long, enableLeft: Boolean, typeLeft: Long, colorLeft: Color, enableRight: Boolean, typeRight: Long, colorRight: Color, customLeft: Texture? = null, customRight: Texture? = null) {
        _icall_Unit_Long_Boolean_Long_Color_Boolean_Long_Color_nObject_nObject(setSlotMethodBind, this.rawMemory, idx, enableLeft, typeLeft, colorLeft, enableRight, typeRight, colorRight, customLeft, customRight)
    }
