...
open class ItemList : Control {
    ...
    open fun addItem(text: String, icon: Texture? = null, selectable: Boolean = true) {
        _icall_Unit_String_nObject_Boolean(addItemMethodBind, this.rawMemory, text, icon, selectable)
    }
