...
open class Navigation : Spatial {
    ...
    open fun navmeshAdd(mesh: NavigationMesh, xform: Transform, owner: Object? = null): Long {
        return _icall_Long_Object_Transform_nObject(navmeshAddMethodBind, this.rawMemory, mesh, xform, owner)
    }
