...
open class Navigation2D : Node2D {
    ...
    open fun navpolyAdd(mesh: NavigationPolygon, xform: Transform2D, owner: Object? = null): Long {
        return _icall_Long_Object_Transform2D_nObject(navpolyAddMethodBind, this.rawMemory, mesh, xform, owner)
    }
