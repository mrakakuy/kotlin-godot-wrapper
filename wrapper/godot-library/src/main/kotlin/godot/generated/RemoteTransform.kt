...
open class RemoteTransform : Spatial {
    constructor() : super("RemoteTransform")
    ...
    companion object {
        infix fun from(other: Spatial): RemoteTransform = RemoteTransform("").apply { setRawMemory(other.rawMemory) }
        infix fun from(other: Node): RemoteTransform = RemoteTransform("").apply { setRawMemory(other.rawMemory) }
        infix fun from(other: Object): RemoteTransform = RemoteTransform("").apply { setRawMemory(other.rawMemory) }
        infix fun from(other: Variant): RemoteTransform = fromVariant(RemoteTransform(""), other)
    ...
    // Methods
    private val setRemoteNodeMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "set_remote_node") }
    open fun setRemoteNode(path: NodePath) {
        _icall_Unit_NodePath(setRemoteNodeMethodBind, this.rawMemory, path)
    }


    private val getRemoteNodeMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "get_remote_node") }
    open fun getRemoteNode(): NodePath {
        return _icall_NodePath(getRemoteNodeMethodBind, this.rawMemory)
    }


    private val setUseGlobalCoordinatesMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "set_use_global_coordinates") }
    ...
    private val getUseGlobalCoordinatesMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "get_use_global_coordinates") }
    open fun getUseGlobalCoordinates(): Boolean {
        return _icall_Boolean(getUseGlobalCoordinatesMethodBind, this.rawMemory)
    }


    private val setUpdatePositionMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "set_update_position") }
    ...
    private val getUpdatePositionMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "get_update_position") }
    open fun getUpdatePosition(): Boolean {
        return _icall_Boolean(getUpdatePositionMethodBind, this.rawMemory)
    }


    private val setUpdateRotationMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "set_update_rotation") }
    ...
    private val getUpdateRotationMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "get_update_rotation") }
    open fun getUpdateRotation(): Boolean {
        return _icall_Boolean(getUpdateRotationMethodBind, this.rawMemory)
    }


    private val setUpdateScaleMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "set_update_scale") }
    ...
    private val getUpdateScaleMethodBind: CPointer<godot_method_bind> by lazy { getMB("RemoteTransform", "get_update_scale") }
