...
open class Thread : Reference {
    ...
    open fun start(instance: Object, method: String, userdata: Variant? = null, priority: Long = 1): GodotError {
        return GodotError.fromInt(_icall_Long_Object_String_nVariant_Long(startMethodBind, this.rawMemory, instance, method, userdata, priority))
    }
