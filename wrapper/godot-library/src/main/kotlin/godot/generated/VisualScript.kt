...
open class VisualScript : Script {
    ...
    open fun addVariable(name: String, defaultValue: Variant? = null, export: Boolean = false) {
        _icall_Unit_String_nVariant_Boolean(addVariableMethodBind, this.rawMemory, name, defaultValue, export)
    }
